<template>
  <div class="page-container md-layout-column">
    <md-toolbar>
    <!-- Might be needed (Main Show navigation)
      ...
      <!--  Might be needed (Side panel)
      <md-button class="md-icon-button md-primary" @click="showSidepanel = true">
        <fa icon="navicon" class="mr-1"/>
      </md-button>
       -->
      </div>
    </md-toolbar>
